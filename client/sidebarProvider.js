...
class SidebarProvider {
  ...
  _getHtmlForWebview(webview) {
    ...
    return `<!DOCTYPE html>
            ...
            <body>
                <button class="action-button" id="project-btn">Project to File</button>
                <button class="action-button" id="window-btn">Active Window to File</button>
                <button class="action-button" id="readme-btn">Generate README</button>
