    ...
    "undefined" != typeof window &&
        ("function" == typeof window.PointerEvent
            ...
            : "function" == typeof window.TouchEvent &&
              (T = { down: "touchstart", move: "touchmove", up: "touchend touchcancel" }));
    var Z = /^http:[\w\.\/]+svg$/;
    var q = {
        animate: !1,
        canvas: !1,
        ...
        setTransform: function (t, e, n) {
            ...
            C(
                t,
                "transform",
                "scale(".concat(e.scale, ") translate(").concat(o, "px, ").concat(r, "px)"),
            ),
                a &&
                    i &&
    ...
    function t(u, f) {
        ...
        function A(t) {
            ...
            p &&
                ...
                n &&
                    (0 === d && (d = W(M)),
                    E((o = b(((W(M) - d) * f.step) / 80 + s).scale), e, { animate: !1 }, t)),
                (n && !f.pinchAndPan) ||
                    x(r + (e.clientX - i) / o, a + (e.clientY - c) / o, { animate: !1 }, t));
        }
        function P(t) {
            1 === M.length &&
                g("panzoomend", { x: m, y: h, scale: v, isSVG: l, originalEvent: t }, f);
            var e = M;
